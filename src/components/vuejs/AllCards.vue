...
<template>
	<div class="mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
		<div class="flex flex-col items-center justify-center gap-3 pb-6 sm:flex-row">
		...
		<div class="flex items-center justify-center gap-4 pb-8">
			<div class="font-body flex items-center gap-2 text-sm tracking-wider">
			...
			<button
				...
				class="text-text-muted hover:text-accent font-body text-xs font-semibold tracking-wider uppercase transition-colors"
			>
				Limpiar
			</button>
		</div>
